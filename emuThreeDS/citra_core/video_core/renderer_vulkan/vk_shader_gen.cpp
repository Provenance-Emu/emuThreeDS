...
PicaFSConfig::PicaFSConfig(const Pica::RegsInternal& regs, const Instance& instance) {
...
void PicaShaderConfigCommon::Init(const Pica::RasterizerRegs& rasterizer,
                                  const Pica::ShaderRegs& regs, Pica::ShaderSetup& setup) {
...
PicaVSConfig::PicaVSConfig(const Pica::RasterizerRegs& rasterizer, const Pica::ShaderRegs& regs,
                           Pica::ShaderSetup& setup, const Instance& instance) {
    state.Init(rasterizer, regs, setup);
    use_clip_planes = instance.IsShaderClipDistanceSupported();
}

void PicaGSConfigCommonRaw::Init(const Pica::RegsInternal& regs) {
...
PicaFixedGSConfig::PicaFixedGSConfig(const Pica::RegsInternal& regs, const Instance& instance) {
    state.Init(regs);
    use_clip_planes = instance.IsShaderClipDistanceSupported();
}
